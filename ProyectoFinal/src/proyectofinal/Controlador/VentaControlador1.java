...
public class VentaControlador1 {
    ...
    public VentaControlador1(Cafe1[] cafes, int totalCafes) {
        this.cafes = cafes;
        this.totalCafes = totalCafes;

        this.ventas = new Venta1[100];
        this.totalVentas = 0;
    ...
    public void registrarVenta() {
        ...
        Archivo1.sobrescribir("Datos/cafes.txt", obtenerDatosCafes());

        // Crear la venta
        int idVenta = totalVentas + 1;
        LocalDate fecha = LocalDate.now();

        Venta1 venta = new Venta1(
                idVenta,
                cafeSeleccionado,
                cantidad,
                total,
    ...
    public void guardarVenta(Venta1 venta) {
        Archivo1.guardar("Datos/ventas.txt", venta.toString());
    }
    
    public void generarBoleta(Venta1 venta) {
        System.out.println("\n====================================");
    ...
    String[] datos = Archivo1.leer("Datos/ventas.txt");
