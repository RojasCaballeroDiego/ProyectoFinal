...
public class CafeControlador1 {

    private Cafe1[] cafes;
    private int totalCafes;
    private Scanner sc;

    public CafeControlador1() {
        cafes = new Cafe1[100];
        totalCafes = 0;
    ...
    public void cargarCafes() {
        ...
        String[] datos = Archivo1.leer("Datos/cafes.txt");
    ...
    public void guardarCafe(Cafe1 cafe) {
        Archivo1.guardar("Datos/cafes.txt", cafe.toString());
    }
    ...
    public void registrarCafe() {
        ...
        Cafe1 cafe = new Cafe1(codigo, nombre, categoria, tamaño, precio, stock);
    ...
    public void guardarTodosLosCafes() {
        ...
        Archivo1.sobrescribir("Datos/cafes.txt", datos);
    }
}