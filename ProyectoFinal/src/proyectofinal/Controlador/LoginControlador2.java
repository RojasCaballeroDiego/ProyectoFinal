...
import proyectofinal.Modelo.Usuario2;
...
public class LoginControlador2 {
    ...
    public LoginControlador2() {
        
        usuarios = new Usuario2[100];
        totalUsuarios = 0;
    ...
    public void registrarUsuario() {
        ...
        Usuario2 usuario = new Usuario2(nombre, correo, contraseña);

        usuarios[totalUsuarios] = usuario;
        totalUsuarios++;

        Archivo2.guardar("Datos/usuarios.txt", usuario.toString());
    ...
    String[] datos = Archivo2.leer("Datos/usuarios.txt");
